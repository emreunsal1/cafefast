...
import {
  CAMPAIGN_EXISTS_IN_MENU_MIDDLEWARE, CATEGORY_EXISTS_IN_MENU_MIDDLEWARE, MENU_EXISTS_MIDDLEWARE, PRODUCT_EXISTS_IN_COMPANY_MIDDLEWARE,
...
router.post(
  ...
  COMPANY_MIDDLEWARE,
  MENU_EXISTS_MIDDLEWARE,
  CAMPAIGN_EXISTS_IN_MENU_MIDDLEWARE,
  addCampaignToMenuController,
);
router.delete(
  "/:menuId/campaign/:campaignId",
